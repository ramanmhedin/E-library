            ...
            ->filters([
                ...
                SelectFilter::make('department_id')
                    ->options(function (Get $get) {
                        // Only query departments if a college_id is selected
                        if ($collegeId = $get('college_id')) {
                            return Department::where('college_id', $collegeId)->pluck("name", "id");
                        }
                        // Optionally, return an empty collection or default option if no college is selected
                        return collect();
                    }),
